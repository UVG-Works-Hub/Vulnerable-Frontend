...
const Mantenimiento = () => {
  ...
  return (
    <div className={styles}>
      <nav>
        <button type="submit" onClick={handleClickUpdateMedico}>
          Actualizar Medico
        </button>
        <button type="submit" onClick={handleClickAddMedico}>
          Agregar Medico
        </button>
        <button type="submit" onClick={handleClickUpdateUsuario}>
          Actualizar Usuario
        </button>
        <button type="submit" onClick={handleClickAddUsuario}>
          Agregar Usuario
        </button>
        <button type="submit" onClick={handleClickUpdatePaciente}>
          Actualizar Paciente
        </button>
        <button type="submit" onClick={handleClickAddPaciente}>
          Agregar Paciente
        </button>
        <button type="submit" onClick={handleClickReporteria}>
          Reporteria
        </button>

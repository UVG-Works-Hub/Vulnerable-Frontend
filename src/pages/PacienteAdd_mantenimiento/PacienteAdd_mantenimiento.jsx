...
const PacienteAdd_mantenimiento = () => {
  ...
  const agregarPaciente = async () => {
    try {
      ...
      if (!masaValidation.isValid) {
        throw new Error(
          `Masa corporal: ${masaValidation.error || "Debe ser un número positivo"}`,
        );
      }
      ...
      if (!alturaValidation.isValid) {
        throw new Error(
          `Altura: ${alturaValidation.error || "Debe ser un número positivo"}`,
        );
      }
      ...
      if (!pesoValidation.isValid) {
        throw new Error(
          `Peso: ${pesoValidation.error || "Debe ser un número positivo"}`,
        );
      }
  ...
  return (
    <div className={styles}>
      ...
      />
      {nombreError && (
        <span style={{ color: "red", fontSize: "12px" }}>{nombreError}</span>
      )}
      <br />
      ...
      />
      {apellidoError && (
        <span style={{ color: "red", fontSize: "12px" }}>{apellidoError}</span>
      )}
      <br />
      ...
      />
      {direccionError && (
        <span style={{ color: "red", fontSize: "12px" }}>{direccionError}</span>
      )}
      <br />
      ...
      />
      {telefonoError && (
        <span style={{ color: "red", fontSize: "12px" }}>{telefonoError}</span>
      )}
      <br />
      ...
      />
      {masaError && (
        <span style={{ color: "red", fontSize: "12px" }}>{masaError}</span>
      )}
      <br />
      ...
      />
      {alturaError && (
        <span style={{ color: "red", fontSize: "12px" }}>{alturaError}</span>
      )}
      <br />
      ...
      />
      {pesoError && (
        <span style={{ color: "red", fontSize: "12px" }}>{pesoError}</span>
      )}
      <br />
      ...
      />
      {evolucionError && (
        <span style={{ color: "red", fontSize: "12px" }}>{evolucionError}</span>
      )}
      <br />
      ...
      />
      {statusError && (
        <span style={{ color: "red", fontSize: "12px" }}>{statusError}</span>
      )}
      <br />

...
const PacienteUpdate_mantenimiento = () => {
  ...
  const updateName = async () => {
    try {
      ...
      const response = await Axios.put(
        `http://localhost:3000/api/v1/pacientes/nombre/${dpiValidation.sanitizedValue}`,
        {
  ...
  const updateApellido = async () => {
    try {
      ...
      const response = await Axios.put(
        `http://localhost:3000/api/v1/pacientes/apellido/${dpiValidation.sanitizedValue}`,
        {
  ...
  const updateDireccion = async () => {
    try {
      ...
      const response = await Axios.put(
        `http://localhost:3000/api/v1/pacientes/direccion/${dpiValidation.sanitizedValue}`,
        {
  ...
  const updateTelefono = async () => {
    try {
      ...
      const response = await Axios.put(
        `http://localhost:3000/api/v1/pacientes/telefono/${dpiValidation.sanitizedValue}`,
        {
  ...
  const updateMasaCorporal = async () => {
    try {
      ...
      const response = await Axios.put(
        `http://localhost:3000/api/v1/pacientes/masa-corporal/${dpiValidation.sanitizedValue}`,
        {
  ...
  const updateAltura = async () => {
    try {
      ...
      if (!alturaValidation.isValid) {
        throw new Error(
          alturaValidation.error || "Debe ser un número positivo",
        );
      }

      const response = await Axios.put(
        `http://localhost:3000/api/v1/pacientes/altura/${dpiValidation.sanitizedValue}`,
        {
  ...
  const updatePeso = async () => {
    try {
      ...
      const response = await Axios.put(
        `http://localhost:3000/api/v1/pacientes/peso/${dpiValidation.sanitizedValue}`,
        {
  ...
  const updateAdiccion = async () => {
    try {
      ...
      const response = await Axios.put(
        `http://localhost:3000/api/v1/pacientes/adicciones/${dpiValidation.sanitizedValue}`,
        {
  ...
  const updateEvolucion = async () => {
    try {
      ...
      const response = await Axios.put(
        `http://localhost:3000/api/v1/pacientes/evolucion/${dpiValidation.sanitizedValue}`,
        {
  ...
  const updateStatus = async () => {
    try {
      ...
      const response = await Axios.put(
        `http://localhost:3000/api/v1/pacientes/status/${dpiValidation.sanitizedValue}`,
        {
  ...
  return (
    <div className={styles}>
      ...
      />
      {dpiError && (
        <span style={{ color: "red", fontSize: "12px" }}>{dpiError}</span>
      )}
      ...
      <br />
      <button type="submit" onClick={handleClickMasaCorporal}>
        Cambiar
      </button>
      ...
      <br />
      <button type="submit" onClick={handleClickAltura}>
        Cambiar
      </button>
      ...
      <br />
      <button type="submit" onClick={handleClickPeso}>
        Cambiar
      </button>
      ...
      <br />
      <button type="submit" onClick={handleClickAdiccion}>
        Cambiar
      </button>
      ...
      <br />
      <button type="submit" onClick={handleClickEvolucion}>
        Cambiar
      </button>
      ...
      <br />
      <button type="submit" onClick={handleClickStatus}>
        Cambiar
      </button>
    </div>
  );
